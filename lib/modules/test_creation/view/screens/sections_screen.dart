...
import 'package:quiz/modules/test_creation/view/view_model/sections_controller.dart';
      ...
      body: Form(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) => SectionPanel(
            ...
            sectionsModel: controller.sectionsModelList[index],
          ),
        ),
      ),
    );
